package com.craisinlord.apple_cows.content.client.model;

import com.craisinlord.apple_cows.AppleCows;
import com.craisinlord.apple_cows.content.entity.AppleCowEntity;
...
public class AppleCowModel extends GeoModel<AppleCowEntity> {
    private static final ResourceLocation MODEL =
            ResourceLocation.fromNamespaceAndPath(AppleCows.MODID, "geo/apple_cow.geo.json");
    private static final ResourceLocation BABY_MODEL =
            ResourceLocation.fromNamespaceAndPath(AppleCows.MODID, "geo/baby_apple_cow.geo.json");
    private static final ResourceLocation ANIMATION =
            ResourceLocation.fromNamespaceAndPath(AppleCows.MODID, "animations/apple_cow.animation.json");
    private static final ResourceLocation BABY_ANIMATION =
            ResourceLocation.fromNamespaceAndPath(AppleCows.MODID, "animations/baby_apple_cow.animation.json");
    private static final ResourceLocation APPLE_TEXTURE =
            ResourceLocation.fromNamespaceAndPath(AppleCows.MODID, "textures/entity/apple_cow/apple_cow.png");
    private static final ResourceLocation APPLE_SHEARED_TEXTURE =
            ResourceLocation.fromNamespaceAndPath(AppleCows.MODID, "textures/entity/apple_cow/apple_cow_sheared.png");
    private static final ResourceLocation BABY_APPLE_TEXTURE =
            ResourceLocation.fromNamespaceAndPath(AppleCows.MODID, "textures/entity/apple_cow/baby_apple_cow.png");
    private static final ResourceLocation GOLDEN_TEXTURE =
            ResourceLocation.fromNamespaceAndPath(AppleCows.MODID, "textures/entity/apple_cow/golden_apple_cow.png");
    private static final ResourceLocation GOLDEN_SHEARED_TEXTURE =
            ResourceLocation.fromNamespaceAndPath(AppleCows.MODID, "textures/entity/apple_cow/golden_apple_cow_sheared.png");
    private static final ResourceLocation BABY_GOLDEN_TEXTURE =
            ResourceLocation.fromNamespaceAndPath(AppleCows.MODID, "textures/entity/apple_cow/baby_golden_apple_cow.png");
    private static final ResourceLocation ENCHANTED_TEXTURE =
            ResourceLocation.fromNamespaceAndPath(AppleCows.MODID, "textures/entity/apple_cow/enchanted_golden_apple_cow.png");
    private static final ResourceLocation ENCHANTED_SHEARED_TEXTURE =
            ResourceLocation.fromNamespaceAndPath(AppleCows.MODID, "textures/entity/apple_cow/enchanted_golden_apple_cow_sheared.png");
